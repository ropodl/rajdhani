...
@section('content')
    ...
    <div class="page-header row no-gutters py-4">
        <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
            ...
            <a href="#" class="btn btn-primary mt-4 ml-2">View Contact List</a>
        </div>
    </div>
    <!-- End Page Header -->
    <!-- Default Light Table -->
                                ...
                                <tr>
                                    ...
                                    <td class="col-md-2 col-sm-4">
                                        <div class="d-flex justify-content-center">
                                            <form action="{{route('contactus.destroy', $contact->id)}}" method="post" onsubmit="return confirm('Are you sure?')">
                                                @csrf
                                                @method('DELETE')
