			...
			<div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 p-2 pl-3">
                        ...
                        <textarea class="form-control form-control-lg mb-1" id="iframe" type="text" name="iframe" value="{{old('iframe')?old('iframe'):(isset($edit)?$edit->iframe:'')}}" placeholder="Your video iframe link"></textarea>
                    ...
                    <div class="col-md-12 col-sm-12 p-2 pl-3">
                        ...
                        <input class="form-control form-control-lg mb-1" id="sort" type="text" name="sort" value="{{old('sort')?old('sort'):(isset($edit)?$edit->sort:'')}}" placeholder="Sort Video">
