...
@section('content')
    ...
    <div class="page-header row no-gutters py-4">
        <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
            ...
            <a href="{{route('news.create',['list'=>$news])}}" class="btn btn-primary mt-4 ml-2"><i class="fa fa-plus"></i> Add New News</a>
        </div>
    </div>
    <!-- End Page Header -->
    <!-- Default Light Table -->
                                    ...
                                    <tr>
                                        ...
                                        <td class="col-md-2 col-sm-4">
                                            <div class="d-flex justify-content-center">
                                                <a class="btn btn-warning btn-sm mr-2" href="{{route('news.edit',$new)}}">Edit</a>
                                                <form action="{{route('news.destroy',$new)}}" method="post" onsubmit="return confirm('Are you sure?')">
                                                    @csrf
                                                    @method('DELETE')
